                        ...
                        if(isset($_SESSION['cart'])){ ?>
                            ...
                            <?php endforeach; ?>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" class="text-primary">Rs. <?php echo number_format($total - $vat,2) ?></td>
                                </tr>
                                <tr>
                                    <td colspan="3" class="text-right"><strong>GST (18%)</strong></td>
                                    <td colspan="2" class="text-danger">Rs. <?php echo number_format($vat,2) ?></td>
                                </tr>
                                <tr>
                                    <td colspan="3" class="text-right"><strong>TOTAL</strong></td>
                                    <td colspan="2" class="text-danger"><strong>Rs. <?php echo number_format($total,2); ?></strong></td>
                                </tr>
